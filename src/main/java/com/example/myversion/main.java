...
public class main extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        shape rectangle = new rectangleShape(150, 10, 150, 200);
        rectangle.setBorderColor(Color.BLACK);
        rectangle.setInColor(Color.YELLOW);

        shape ellipse = new ellipseShape(500, 110, 100, 60);
        ...
        shape polygon = new polygonShape(polygonPoints);
        ...
        shape polyline = new polylineShape(polylinePoints);
